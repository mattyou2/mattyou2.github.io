...
// --- INITIALIZATION ---
function initThree() {
    // BUGFIX: Haal de container pas op als de DOM volledig geladen is
...
// --- ANIMATION SYSTEM (BUGFIX: BLIJFT STAAN WAAR JE HET NEERZET) ---
...
function applyKeyframeState(objData, frame) {
    ...
    // Alleen als de animatie expliciet wordt afgespeeld en we op het exacte frame van dat keyframe zijn, passen we het toe.
    if (keys.length <= 1) {
